...
class Kasuskr extends AUTH_Controller {
	...
	public function index() {
		...
		$data['datakasuskr'] 	= $this->M_kasuskr->select_all();

		$data['page'] 		= "KSK";
		$data['judul'] 		= "Kasus Kernet";
		$data['deskripsi'] 	= "Manage Data Kasus Kernet";

		$data['modal_tambah_kota'] = show_my_modal('modals/modal_tambah_kota', 'tambah-kota', $data);

		$this->template->views('kasuskr/home', $data);
	}

	public function tampil() {
		$data['datakasuskr'] = $this->M_kasuskr->select_all();
		$this->load->view('kasuskr/list_data', $data);
	}
