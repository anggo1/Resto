...
class inputBAK extends AUTH_Controller {
	...
	public function index() {
		...
		$data['datalaplaka'] 	= $this->M_bak->select_all();

		$data['page'] 		= "inputBAK";
		$data['judul'] 		= "Berita Acara Kendaraan";
		$data['deskripsi'] 	= "Manage Berita Acara";

		$data['modal_tambah_kota'] = show_my_modal('bak/inputBAK', 'tambah-kota', $data);

		$this->template->views('bak/inputBAK', $data);
	}
