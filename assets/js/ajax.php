<script type="text/javascript">
	...
	function refresh() {
		MyTable = $('#list-data,#table-1,#table-2').dataTable();
	}
...
var MyTable = $('#table-tab').dataTable({
		"responsive": true
		});
var table;
...
$(document).on("click", ".update-dataSatuan", function() {
	...
	//end
//ajax Kargo
	function tampilKargo() {
		$.get('<?php echo base_url('Masterdata/list_cargo'); ?>', function(data) {
			MyTable.fnDestroy();
			$('#data-cargo').html(data);
			refresh();
		});
	}
