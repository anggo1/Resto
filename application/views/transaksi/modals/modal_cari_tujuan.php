<div class="card card-first">
                ...
                <h3 class="card-title">
 				...
 				<div class="card-body">
                    <div class="table-responsive">
                      <table class="table table-bordered table-hover dt-responsive nowrap" id="table-choice">
                        <thead>          
  ...
  foreach ($dataWilayah as $s) {
    ...
    <td class="text-center">
		<button type="button" class="btn btn-sm bg-gradient-warning" onClick="javascript:selectTujuan('<?php echo $s->kode ?>','<?php echo $s->pangkalan ?>')"> <i class="fa  fa-check"></i>Pilih</button></td>
