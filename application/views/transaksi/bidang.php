<div class="msg" style="display:none;">
 ...
 <div class="section-body">
        <button class="form-control btn btn-success" data-toggle="modal" data-target="#tambah-bidang"><i class="glyphicon glyphicon-plus-sign"></i> Tambah Data </button>
    ...
    <td>Aksi</td>
      ...
      <tbody id="data-bid">	</div></div></div>
		  <?php echo $modal_tambah_bidang; ?>
<div id="tempat-modal">
      </tbody>
    </table>
  </div>
